...
def download_all_safetensors(model_name: str, hf_token: Optional[str], cache_dir: Optional[str]) -> List[str]:
	paths: List[str] = []
...
def consolidate_weights_from_files(safetensor_paths: List[str]) -> Dict[str, torch.Tensor]:
